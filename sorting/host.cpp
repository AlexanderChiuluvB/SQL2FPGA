...
void sort(std::vector<uint64_t,aligned_allocator<uint64_t>> & h_input, std::vector<uint64_t,aligned_allocator<uint64_t>> & h_output, const std::string & binaryFile) {
...
//OPENCL HOST CODE AREA START
    sort(h_input, h_output, binaryFile);
